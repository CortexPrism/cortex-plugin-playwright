# Changelog — Playwright Browser Agent

## [1.0.0] — 2026-06-15

### Added
- Initial plugin scaffold: browser automation via Cortex tools
- **7 tools**: `browser_navigate`, `browser_click`, `browser_type`, `browser_screenshot`, `browser_extract`, `browser_evaluate`, `browser_close`
